...
const readme = `\
### 🚴 在迈向未来赛博新世界的路上 ${progressBarOfThisYear} ${(progressOfThisYear * 100).toFixed(2)} % ${new Date().getFullYear()}
...
- 😄: xipochen@Oscar
- 🗣️: I’m currently practicing Python, Blockchain, AI...
